...
namespace StatSystem.Editor
{
    public class StatDatabaseEditorWindow : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Stats System/Scripts/Editor/StatDatabaseEditorWindow.uxml");
            visualTree.CloneTree(root);
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Stats System/Scripts/Editor/StatDatabaseEditorWindow.uss");
